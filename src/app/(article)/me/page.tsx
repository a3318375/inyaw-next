                    ...
                    <div className="md:max-w-content mx-auto">
                        <div className="prose max-w-none p-4 dark:prose-invert">
                            <div className="entry-content">
                                <h2 className="mt-5">讲讲我个人的一些状况</h2>
                                ...
                                <p>项目规模还是挺大的，有个50几台服务器，最开始是ssm + shiro + redis +
                                    手动加jar包。后来项目大改版，代码无法复用，我提出了项目结构变成，整个项目就变成了spring
                                    boot + maven + shiro + redis， 我还搭建了maven私服。</p>
