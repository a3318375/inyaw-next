...
export default function CommentSend({avaer}: { avaer?: string | null }) {
    const [selected, setSelected] = useState(moods[5])

    return (
        <div className="rounded-xl border-2 border-gray-100 mt-6">
                        ...
                        <div className="relative">
                            <div
                                ...
                                <textarea
                                    ...
                                    name="comment"
                                    id="comment"
                                    className="block w-full resize-none border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-0 sm:text-sm sm:leading-6"
